                ...
                <div class="card-body">
                    <form action="{{ route('user.update', $user->id) }}" method="post">
                        ...
                        <div class="position-relative form-group">
                            ...
                            <input name="name" id="exampleName" placeholder="Enter your name" type="text" value="{{ $user->name }}" class="form-control @error('name') is-invalid @enderror">
                        </div>
                        <div class="position-relative form-group">
                            <label for="exampleEmail" class="">Email</label>
                            <input name="email" id="exampleEmail" placeholder="Enter your email" type="email" value="{{ $user->email }}" class="form-control @error('email') is-invalid @enderror">
                        </div>
                        <div class="position-relative form-group">
